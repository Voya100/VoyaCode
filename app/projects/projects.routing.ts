...
const routes: Routes = [
  ...
  { path: 'rock-paper-scissors', loadChildren: './rock-paper-scissors/rock-paper-scissors.module#RockPaperScissorsModule', data: {title: 'Rock, Paper, Scissors'}},
  { path: 'slay-the-dragon', loadChildren: './slay-the-dragon/slay-the-dragon.module#SlayTheDragonModule', data: {title: 'Slay the Dragon'}},
