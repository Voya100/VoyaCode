...
describe('#King', function(){
  ...
  describe('castling', function(){
    ...
    let blackKing: Piece, blackRook1: Piece, blackRook2: Piece;
    let whiteKing: Piece, whiteRook1: Piece, whiteRook2: Piece;
    ...
    it('should move king and rook correctly (left black)', function(){
      ...
      expect(blackRook1.x).toBe(3);
      expect(blackRook1.y).toBe(0);
    });
    
    it('should move king and rook correctly (right black)', function(){
      game.changeTurn();
      game.movePiece(blackKing, game.board[0][6]);
      expect(blackKing.x).toBe(6);
      expect(blackKing.y).toBe(0);
      expect(blackRook2.x).toBe(5);
      expect(blackRook2.y).toBe(0);
    });
    
    it('should move king and rook correctly (left white)', function(){
      game.movePiece(whiteKing, game.board[7][2]);
      expect(whiteKing.x).toBe(2);
      expect(whiteKing.y).toBe(7);
      expect(whiteRook1.x).toBe(3);
      expect(whiteRook1.y).toBe(7);
    });
    
    it('should move king and rook correctly (right white)', function(){
      game.movePiece(whiteKing, game.board[7][6]);
      expect(whiteKing.x).toBe(6);
      expect(whiteKing.y).toBe(7);
      expect(whiteRook2.x).toBe(5);
      expect(whiteRook2.y).toBe(7);
    });
    ...
    it('should not work if there piece right next to leftermost rook', function(){
      testMoveTiles(4, 0, [
        ['BR','BK' ,' ','X' ,'BX','X' ,'BP','BR'],
        [' ' ,'  ',' ' ,'X' ,'X' ,'X' ,' ' ,' ' ],
        [' ' ,' ' ,' ' ,' ' ,' ' ,' ' ,' ' ,' ' ],
