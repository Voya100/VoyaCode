...
export class RpsGameLogicService {
  ...
  constructor(private storage: LocalStorageService) {
    ...
    if (storage.get('statistics') === undefined || storage.get('statistics') === null) {
      ...
      this.statistics = storage.get('statistics') as RpsStatistics;
      this.settings = storage.get('settings') as RpsSettings;
      this.player1.name = storage.get('playerName') as string;
    }
  }
